...
*/
  async createCharacterImage() {
    ...
    // }
    image = await createCanvasImage({ context, src: 'https://img2.baidu.com/it/u=47347863,903517934&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=497' });
    this.initCharacterImage();
  },
  /**
   * @description: 创建背景图片
  ...
  async createBackgroundImage() {
    backgroundImage = await createCanvasImage({ context, src: backgroundUrl })
  },
  /**
   * @description: 初始化人物位置
   * @return {*}
